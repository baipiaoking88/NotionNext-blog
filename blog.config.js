...
const BLOG = {
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://originfastly.jsdelivr.net/gh/mocchen/cssmeihua/js/aixin.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  CUSTOM_EXTERNAL_CSS: ['https://originfastly.jsdelivr.net/gh/baipiaoking88/mypic@4.0/blog-medium-202602.css'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']
